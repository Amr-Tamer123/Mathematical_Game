...
enOperationType ReadOpType()
{
	...
	do
	{
		cout << "Enter Operation Type [1] Add, [2] Sub, [3] Mul, [5] Mix ? ";
		cin >> OpType;
...
int SimpleColcalator(short Number1, short Number2, enOperationType OpType)
{
	switch (OpType)
	{
...
stQuestion GenerateQuestion(enQuestionsLevel QuestionLevel, enOperationType OpType)
{
	...
	case enQuestionsLevel::EasyLevel:
		...
		Question.CorrectAnswer = SimpleColcalator(Question.Number1, Question.Number2, Question.OperationType);
		return Question;
